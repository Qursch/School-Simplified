...
const clubs: ActivitySlideProps[] = [
	{
		...
		key: "Coding Club",
		clubDesc:
			"In the Simplified Coding Club, you’ll learn the basics of programming and how to apply your new skills in situations like contest programming, hackathons, and personal projects. Programming is an awesome skill to learn, so we urge everyone of all skill levels to join! Not only will you be able to create projects relevant to what you want to do, but you can use them in real life as well.",
	...
	},
	{
		...
		key: "Cooking Club",
		clubDesc:
			"In the cooking club, our goal is to not only provide an opportunity to enhance essential life skills, but also to have fun and build a strong community! Anyone over 13+ can join regardless of having true experience. Club members can learn from one another and explore new ideas and recipes.",
	...
	},
	{
		...
		key: "Music Club",
		clubDesc:
			"In this club, we gather like-minded musicians and help with musical techniques such as music, tempos, composing, rhythms. This is a great opportunity for you to interact with other musicians and develop your musical career! Music club consists of a variety of musicians, so regardless of your instrument (woodwind, strings, etc.), feel free to join and play with us!",
		src: "/clubs/music.png",
		link: "https://forms.gle/YUYZZrtFGzaCXDhNA",
	},
	// {
	...
	//},
	{
		...
		clubDesc:
			"In the Simplified Mathematics Club, you will learn about all the fundamentals concepts of mathematics! We regularly post math facts and questions, and you can feel free to suggest your own. If that is not enough, we also demonstrate math applications and have tournaments that you can compete in!",
